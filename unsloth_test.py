...
if __name__ == "__main__":
    ...
    # no eval
    # epochs = 2
    run_name = "exp-5 (basic mh simple - 1.7)"
    ...
    eval_set = copy.deepcopy(all_data[-eval_limit:])
    trainer = MultihopGRPOTrainer(
        ...
        args=training_args,
        iterations = 2,
        reward_funcs=MultihopGRPOTrainer.get_default_reward_functions(prompts_and_tools)[:2],
